...
public class NextTokenParse extends Parse{
	private TypeToken tokenType;
	private Token nextToken;
	private String name;
	private NextTokenParse(TypeToken tokenType, String name, Token nextToken) {
	...
	public static NextTokenParse newParse(TypeToken tokenType, String name, Token nextToken) {
		NextTokenParse parse = new NextTokenParse(tokenType, name, nextToken);
		return parse;
	}
}
